...
var branch = process.env.TINA_BRANCH || process.env.HEAD || process.env.CF_PAGES_BRANCH || "main";
var photoField = (name, label, description) => ({
  type: "object",
  name,
  label,
  description,
  fields: [
    {
      ...
      name: "src",
      label: "Photo",
      description: "Tap to choose an existing photo or upload a new one. Any size or shape is fine \u2014 the site resizes and optimises it for you. No need to crop or shrink it first."
    },
    {
      type: "string",
      name: "alt",
      label: "Photo description",
      description: "A few words describing what's in the photo, e.g. 'The gated yard entrance'. Used by screen readers and search engines. Not shown on the page."
    },
    {
      type: "string",
      name: "objectPosition",
      label: "Focus point (advanced \u2014 usually leave as is)",
      description: "Which part of the photo to keep in view if it has to be trimmed to fit the slot. '50% 50%' is the centre. Use '50% 0%' to favour the top, '50% 100%' for the bottom. Leave as '50% 50%' if unsure."
    }
  ]
});
      ...
      // ---------------------------------------------------------------
      {
        ...
        fields: [
          ...
          },
          {
            ...
            description: "What the Call button actually dials. Keep the +44 form with no spaces, e.g. +447777392538."
          },
          {
            type: "string",
            name: "whatsapp",
          ...
          },
          {
            ...
            description: "The message pre-typed for someone when they tap WhatsApp."
          },
          {
            type: "object",
            name: "address",
          ...
          },
          {
            ...
            name: "accessHours",
            label: "Access hours",
            description: "e.g. Mon\u2013Sat 7am\u20137pm. Only appears when the toggle below is on."
          },
          {
            type: "boolean",
            name: "accessHoursConfirmed",
            label: "Show access hours on the site",
            description: "Leave off until the hours above are final. Off shows 'access on request' instead."
          },
          {
            type: "string",
            name: "companyNumber",
          ...
          },
          {
            ...
            description: "Shown under the price table, e.g. 'One week minimum, no long tie-in'. Leave blank for 'No long tie-in'."
          },
          {
            type: "boolean",
            name: "pricesIndicative",
            label: "Show 'prices are indicative' note",
            description: "Turn this off once your prices are final and firm."
          }
        ]
      },
      // ---------------------------------------------------------------
      ...
      // ---------------------------------------------------------------
      {
        ...
        fields: [
          ...
          },
          {
            type: "number",
            name: "priceFrom",
            label: "Price from (\xA3)",
            description: "Just the number, e.g. 35. Leave blank to show the note below instead.",
            ui: {
              validate: (value) => {
          ...
          },
          {
            ...
            description: "Used only when 'Price from' is blank, e.g. 'Call for availability'."
          },
          {
            type: "string",
            name: "whatFits",
          ...
          },
          {
            ...
            name: "available",
            label: "Show this row",
            description: "Turn off to hide this row from the table without deleting it."
          },
          {
            type: "number",
            name: "order",
        ...
        fields: [
          {
            ...
            fields: [
              ...
              ),
              {
                ...
                name: "heading",
                label: "Headline",
                description: "The big headline over the photo. Best kept under about 55 characters, or it can wrap awkwardly on phones.",
                ui: {
                  validate: (v) => v && v.length > 70 ? "That's quite long and may look cramped on phones \u2014 try to trim it." : void 0
                }
              },
              {
                type: "string",
                ...
                description: "The line that leads up to the '\xA3xx a week' price. The price is filled in automatically from your 20ft price, so you don't type it here. Keep a space at the end.",
                ui: { component: "textarea" }
              },
              {
                type: "string",
          ...
          },
          {
            ...
            fields: [
              ...
              },
              {
                ...
                description: "The first three cards. The fourth card, \u2018Easy access\u2019, fills itself in from the access-hours setting in Business details, so it isn't listed here.",
                list: true,
                ui: {
                  itemProps: (item) => ({
          ...
          },
          {
            ...
            description: "The address and map fill themselves in from Business details \u2014 you only edit the directions and the areas line here.",
            fields: [
              { type: "string", name: "heading", label: "Section heading" },
              {
                type: "object",
        ...
        fields: [
          {
            ...
            fields: [
              ...
              },
              {
                ...
                description: "Leads up to the '\xA3xx a week' price, which is added automatically. Keep a space at the end.",
                ui: { component: "textarea" }
              },
              {
                type: "string",
              ...
              },
              {
                ...
                name: "body",
                label: "Paragraphs",
                description: "The main text, one box per paragraph. Use the + button to add a paragraph, or the handle to reorder them.",
                list: true,
                ui: {
                  component: "textarea",
                  itemProps: (item) => ({
          ...
          },
          {
            ...
            fields: [
              ...
              photoField("image", "Section photo", "The photo in this second section."),
              {
                ...
                name: "body1",
                label: "Paragraph",
                description: "The second line about larger vehicles / HGVs fills itself in and isn't edited here.",
                ui: { component: "textarea" }
              }
            ]
          }
